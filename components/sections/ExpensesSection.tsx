...
const ExpensesSection = () => {
  ...
  const [singleExportExpense, setSingleExportExpense] = useState(null);
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          title="Export filtered expenses"
        >
      ...
      <ExportModal isOpen={showExportModal} onClose={() => setShowExportModal(false)} onExport={(type) => { setShowExportModal(false); /* TODO: implement export logic */ }} sectionName="Expenses" />
      <SingleEntryExportModal isOpen={!!singleExportExpense} onClose={() => setSingleExportExpense(null)} onExport={(type, size) => { setSingleExportExpense(null); /* TODO: implement single export logic */ }} entryType="Expense" />
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex space-x-2">
                      ...
                      <button 
                        onClick={() => setSingleExportExpense(expense)}
