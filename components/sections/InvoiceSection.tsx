...
const InvoiceSection: React.FC<InvoiceSectionProps> = ({
  ...
  return (
    <div className="w-full p-2 sm:p-4 md:p-6 md:max-w-7xl mx-auto">
      ...
      <ExportModal isOpen={showExportModal} onClose={() => setShowExportModal(false)} onExport={(type) => { setShowExportModal(false); /* TODO: implement export logic */ }} sectionName="Invoices" />
      <SingleEntryExportModal isOpen={!!singleExportInvoice} onClose={() => setSingleExportInvoice(null)} onExport={(type, size) => { setSingleExportInvoice(null); /* TODO: implement single export logic */ }} entryType="Invoice" />
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <button onClick={() => setSingleExportInvoice(invoice)} className="p-2 rounded-full bg-emerald-700 text-emerald-100 hover:bg-emerald-600 transition-colors duration-200 flex items-center justify-center w-8 h-8" title="Export this invoice">
